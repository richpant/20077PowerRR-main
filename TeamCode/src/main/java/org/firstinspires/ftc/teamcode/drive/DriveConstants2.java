...
public class DriveConstants2 {
     ...
     */
    public static final double TICKS_PER_REV = 537.6; //was 537.6
    ...
    public static double GEAR_RATIO = 1; //was 1 // output (wheel) speed / input (motor) speed
     ...
     * empirically tuned.
     */
    public static double kV = 0.01578 / rpmToVelocity(MAX_RPM);
    public static double kA = 0.00175;
    public static double kStatic = 0.07101;
     ...
     */
    public static double MAX_VEL = 50.00;//52.48291908330528
